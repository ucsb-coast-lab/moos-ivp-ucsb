...
void showSynopsis()
{
  blk("SYNOPSIS:                                                       ");
  blk("------------------------------------                            ");
  blk("  The uSimROMS2 application is a simple simulator of water      ");
...
void showHelpAndExit()
{
  blk("                                                                ");
  blu("=============================================================== ");
  blu("Usage: uSimROMS2 file.moos [OPTIONS]                          ");
  blu("=============================================================== ");
  blk("                                                                ");
  showSynopsis();
  blk("                                                                ");
  ...
  blk("      Launch uSimROMS2 with the given process name rather     ");
  blk("      than uSimROMS2.                                         ");
  mag("  --example, -e                                                 ");

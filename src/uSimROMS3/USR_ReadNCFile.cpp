...
bool USR_MOOSApp::ReadNcFile()
{
  cout << "uSimROMS3: opening file: " << ncFileName << endl;
  ...
  if(!(File.is_valid())) //check if file is open
    {
      cout << "uSimROMS3: error reading file!" << endl;
      return false;
    } else cout <<"uSimROMS3: file opened successfully" << endl;
  ...
  if(!(scalar_var->is_valid())) //check if variable was valid
    {
      cout << "uSimROMS3: error reading scalar variable" << endl;
      return false;
  ...
  if(!(maskRho_var->is_valid())) //check if variable was valid
    {
      cout << "uSimROMS3: error reading mask_rho variable, exiting" << endl;
      return false;
    }else cout << "uSimROMS3: mask_rho variable found" << endl;
  ...
  if(!(lat_var->is_valid())) //check if variable was valid
    {
      cout << "uSimROMS3: error reading latitude variable, exiting" << endl;
      return false;
    }else cout << "uSimROMS3: latitude variable found" << endl;

  //find lon variable    
  NcVar* lon_var = File.get_var((const char* ) lonVarName.c_str()); 
  if(!(lon_var->is_valid())) //check if variable was valid
    {
      cout << "uSimROMS3: error reading longitude variable, exiting" << endl;
      return false;
    }else cout << "uSimROMS3: longitude variable found" << endl;

  //find time variable
  NcVar* time_var = File.get_var((const char*) timeVarName.c_str());
    if(!(time_var->is_valid())) //check if variable was valid
    {
      cout << "uSimROMS3: error reading time variable, exiting" << endl;
      return false;
    }else cout << "uSimROMS3: time variable found" << endl;

  //find depth variable 
  NcVar* s_var = File.get_var((const char*) sVarName.c_str());
  if(!(s_var->is_valid()))
    {
      cout << "uSimROMS3: error reading depth variable, exiting" << endl;
      return false;
    }else cout << "uSimROMS3: depth variable found" << endl;

   NcVar* bathy_var = File.get_var((const char*) bathyVarName.c_str());
  if(!bathy_var->is_valid())
    {
      cout << "uSimROMS3: error reading bathymetry variable, exiting" << endl;
      return false;
    }else cout << "uSimROMS3: bathymetry variable found" << endl;
  ...
  cout << "uSimROMS3: field for \"" << varName << "\" populated" << endl;
  ...
  cout << "uSimROMS3: latitude field populated" << endl;
  ...
  cout << "uSimROMS3: longitude field populated" << endl;
  
  //read in time values 
  time = new double [time_vals]; 
  time_var->get(&time[0], time_vals);
  cout << "uSimROMS3: time field populated" << endl;
  ...
  cout << "uSimROMS3: depth field populated" << endl;
  ...
  cout << "uSimROMS3: bathymetry field populated" << endl;    
  return true;
